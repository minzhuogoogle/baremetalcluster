...
echo "      Number of clusters: integer from 1 to 16. By default it is 2."
echo
echo "Note:"
...
if [ $cluster_index -gt 255 ]; then
  echo "cluster index should be less than 255."
  exit 1
fi

if [ $totalclusters -gt 16 ]; then
...
echo "  10.201.cluster_id.x/productpage, x= 10, 42 and 74"
echo "Nginx is able to be accessed at:"
echo "  10.201.cluster_id.y, y=11, 43, and 75"
